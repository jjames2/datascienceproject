...
```{r}
tractdata <- dcast(data[data$GeographicLevel=="Census Tract" & data$DataValueTypeID=="AgeAdjPrv",], UniqueID+CityName+StateAbbr+GeoLocation+Year+PopulationCount+GeographicLevel~Short_Question_Text, value.var="Data_Value")
ggplot(tractdata, aes(x=`Current Smoking`,y=`Current Asthma`)) + geom_point() + geom_smooth(method='lm')
```
